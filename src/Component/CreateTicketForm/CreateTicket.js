...
export const CreateTicket = (props) => {
  ...
  const anchor ="right";
    ...
    const createTicketForm=(event)=>{
      ...
      data1= {ticketName:"asdnasd",status:"processing"};
  }
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <TextField  name="name" {...register('name')} className="inputboxx" />

                <Label name="Pipeline" />
                <CustomDropdown id="pipeline"  name="pipeline" {...register('pipeline')}  option={pipeline} />
         {/*
